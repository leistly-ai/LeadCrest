...
export default function LandingPage() {
  ...
  useEffect(() => {
    const generateDemoQR = async () => {
      const demoUrl = `${WHATSAPP_LINK_BASE}?text=Hi, I'm interested in seeing how LeadCrest works! [AgentID:demo]`;
      try {
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <p className="text-xl text-white/60 leading-relaxed max-w-lg">
                  Scan the QR code to see how our AI assistant qualifies leads in real-time. No account required to test the experience.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-white/40 uppercase tracking-widest">Global: {GLOBAL_WHATSAPP_NUMBER}</p>
                  </div>
                </div>
                <button 
